...
```json
{
  "mcpServers": {
    "mermaid-ai-links": {
      "command": "npx",
      "args": ["-y", "mermaid-ai-links@0.2.2", "mcp"]
    }
  }
}
```
...
```zsh
npx -y mermaid-ai-links@0.2.2 --version
npx -y mermaid-ai-links@0.2.2 doctor
npx -y mermaid-ai-links@0.2.2 sync /absolute/path/to/note.md
npx -y mermaid-ai-links@0.2.2 start
```
